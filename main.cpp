...
Estatisticas Ordenar(unsigned long *v, unsigned long n){	//ordena o vetor
...
int main(int argc, char **argv){
    printf("|                                                    |\n");
    int tamanho = 100000;
    printf("| Tamanho do vetor: %d                           |\n", tamanho);//pergunta tamanho do vetor
    ...
    //Depois da ordenação  estatisticas de acordo com o algoritmo escolhido
    printf("| Resultados:                                        |\n");
